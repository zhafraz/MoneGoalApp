 ...
 */
class BeritaLomba2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_berita_lomba2, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val linkUrl = "https://fintechnews.sg/120331/singapore-fintech-festival-2025/mas-2025-global-fintech-hackcelerator-finalists/"
        ...
        tvLinkCTA?.setOnClickListener {
            try {
                ...
                android.util.Log.e("BeritaLomba2Fragment", "Error membuka tautan: ${e.message}")
            }
        }
    }
